  ...
  return (
    <main className="mx-auto min-h-screen max-w-md bg-[#f8faf9] p-6 pb-28">
      ...
      <div className="text-center mt-10">
        ...
        <h1 className="mt-6 text-3xl font-bold">Skin Concern Check</h1>
        
        <p className="mt-4 text-lg text-[#526158]">
          This screening uses a clear photo of your skin.
        </p>
        
        <div className="mt-8">
          <ListenButton text="This screening uses a clear photo of your skin. Press start check when you are ready." />
        </div>
